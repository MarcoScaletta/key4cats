...
fig.canvas.manager.set_window_title('Results of 3-internal-behavior (full)')

with open('result_metrics_3-full', 'w') as f:
...
if len(sys.argv) > 1 and sys.argv[1] == "-no-show":
    print("not showing plots, as requested. Check \"result_metrics_3-full.png\"")
else:
    plt.show()
