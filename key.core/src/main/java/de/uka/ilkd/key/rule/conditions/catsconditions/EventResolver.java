...
public abstract class EventResolver {

    TraceResolver traceResolver;

    private EventResolver(TraceResolver traceSV){
        this.traceResolver = traceSV;
    }

    public static EventResolver getMethodNameOf(TraceResolver eventSV){
    ...
    public static Object getIdentity(TraceResolver op) {
        return new EventResolver.IdentityMethodNameResolver(op);
    }
    ...
    public static class MethodNameFromEventResolver extends EventResolver {
    ...
    public static class IdentityMethodNameResolver extends EventResolver {
